...
from utils import load_ckpt, load_ckpt_other
...
if __name__ == "__main__":
    ...
    if args.use_vertex_normal: ## use normal vector method as suggested by the author.
        ...
        # nerf_coarse = NeRF()
                               # (nerf_coarse, args.ckpt_path, model_name='nerf_coarse')
        nerf_coarse, nerf_fine = load_ckpt_other()
